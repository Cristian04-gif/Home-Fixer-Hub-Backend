...
public class TechnicalServiceServiceImp implements TechnicalServiceService {
    ...
    public Mono<TechnicalServiceDTO> assignSkill(String technicalId, String serviceId) {
        return profileClient.getTechnicalById(technicalId).flatMap(profile -> {
            ...
            return repository.save(service);
                ...
                .switchIfEmpty(Mono.error(new RuntimeException("NO se pudo enlazar el servicio con eltecnico")));
    }
